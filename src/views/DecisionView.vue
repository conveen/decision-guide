  ...
  >
    ...
    <v-row>
      <v-col cols="12">
        ...
        <v-alert
          v-if="decision.scenarios.length < 2"
          type="info"
          density="compact"
          class="mb-3"
        >
      ...
      <v-card class="mb-6 mt-4">
        ...
        <v-card-text>
          <v-table density="compact">
            ...
            <tbody>
              <tr
                v-for="dimension in decision.dimensions"
                :key="dimension.id"
              >
                <td>
                  <v-text-field
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <p class="text-caption text-grey">
            Anyone with this link can view and edit this decision.
          </p>
        </v-card-text>
        <v-card-actions>
          <v-spacer />
