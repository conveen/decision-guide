<template>
  <div v-if="calculationResult && calculationResult.winner">
    ...
    >
      <div class="text-h5">
        Winner: {{ calculationResult.winner.scenarioName }}
      </div>
      <div class="text-subtitle-1">
        Score: {{ formatNumber(calculationResult.winner.totalScore) }}
      </div>
    </v-alert>
    ...
    <v-card>
      ...
      <v-card-text>
        <v-expansion-panels>
          <v-expansion-panel
            v-for="result in calculationResult.results"
          ...
          >
            ...
            <v-expansion-panel-text>
              <v-table density="compact">
                ...
                <tbody>
                  <tr
                    v-for="contrib in result.dimensionContributions"
