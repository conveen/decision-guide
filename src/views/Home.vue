  ...
  <v-container>
    ...
    <v-row v-else>
      ...
      >
        <v-card
          hover
          @click="openDecision(decision.id)"
        >
          ...
          <v-card-actions>
            ...
            <v-btn
              size="small"
              color="error"
              @click.stop="confirmDelete(decision)"
            >
    ...
    >
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn @click="closeImportDialog">
            Cancel
          </v-btn>
          <v-btn
            color="primary"
            :disabled="!importFile"
            @click="importDecisionsHandler"
          >
            Import
          </v-btn>
        </v-card-actions>
